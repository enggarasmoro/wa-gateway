...
#
# USAGE:
#   bash .claude/skills/frontend-design/scripts/visual-audit.sh http://localhost:5173
#   bash .claude/skills/frontend-design/scripts/visual-audit.sh http://localhost:5173 /about /dashboard
#
# OUTPUT:
