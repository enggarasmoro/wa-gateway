...
> For full diagnosis steps when a transition-stuck blank screen occurs, see the Debugging Protocol's [Frontend module](.claude/skills/debugging-protocol/languages/frontend.md) § CSS × Animation.
